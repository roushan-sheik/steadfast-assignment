...
const ProductList: React.FC<ProductListProps> = ({ page = 1, limit = 10 }) => {
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="bg-gray-200 text-gray-800 w-8 h-8 rounded hover:bg-gray-300 transition-colors"
                >
                  -
                </button>
                ...
                <button
                  ...
                  className="bg-gray-200 text-gray-800 w-8 h-8 rounded hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  +
                </button>
              </div>
